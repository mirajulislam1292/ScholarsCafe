...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative isolate overflow-hidden hero-light bg-sky-soft pt-24 md:pt-28"
    >
        ...
        <div className="hero-copy mt-8 grid grid-cols-1 gap-10 lg:mt-10 lg:grid-cols-[1.5fr_1fr] lg:gap-16">
          <div>
            ...
            >
              ...
              letter, covering applications, scholarships, and the entire admissions journey across
