    ...
    <section id="about" className="bg-dark-gradient py-24 text-white md:py-32">
      <div className="mx-auto max-w-[1280px] px-5 md:px-8">
        <div className="grid grid-cols-1 gap-14 lg:grid-cols-[5fr_6fr]">
          <Reveal>
            <span className="text-xs font-bold uppercase tracking-[0.15em] text-sky-light"><CmsText id="About.10a516acef81">Who We Are</CmsText></span>
        ...
        <div className="mt-24">
          <Reveal className="text-center">
            ...
            <p className="mt-2 text-sky-light"><CmsText id="About.018115599b07">Real people. Real experience. Genuinely here for you.</CmsText></p>
          </Reveal>
