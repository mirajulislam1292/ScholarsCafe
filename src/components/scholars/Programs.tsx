...
export function Programs() {
  ...
  const PROGRAMS = useCmsCollection('courses', DEFAULT_PROGRAMS, (data,id) => ({...data,id,icon:'graduation-cap'}) as typeof DEFAULT_PROGRAMS[number]);
  return (
    <section id="programs" className="bg-white py-24 md:py-32">
      <div className="mx-auto max-w-[1280px] px-5 md:px-8">
        <Reveal className="mx-auto max-w-2xl text-center">
          <span className="text-xs font-bold uppercase tracking-[0.15em] text-sky"><CmsText id="Programs.1d5c2e2d47ce">Our Tracks</CmsText></span>
          <h2 className="mt-4 font-display text-[clamp(2rem,3.5vw,3rem)] font-extrabold text-navy"><CmsText id="Programs.e2cd5f83037c">
            Choose Your Path to the World
          </CmsText></h2>
          <p className="mt-5 text-[17px] leading-relaxed text-slate-600"><CmsText id="Programs.f664216f2985">
