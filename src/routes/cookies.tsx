 ...
 const cmsLabel = useCmsLookup();
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <h2><CmsText id="cookies.c1f30d809e15">1. What is a cookie?</CmsText></h2>
        <p><CmsText id="cookies.c3bf6a1a15e0">
        ...
        <h2><CmsText id="cookies.b96eb84ddad5">2. The cookies we use</CmsText></h2>

        <h3><CmsText id="cookies.1815beefcae4">Strictly necessary</CmsText></h3>
        <p><CmsText id="cookies.4f93e6aa393f">
        ...
        <h3><CmsText id="cookies.f7afbbbdba6f">Performance &amp; analytics</CmsText></h3>
        <p><CmsText id="cookies.0648a8032fab">
        ...
        <h3><CmsText id="cookies.b6656595756e">Functional</CmsText></h3>
        <p><CmsText id="cookies.a2a9239e9ace">
        ...
        <h3><CmsText id="cookies.e4696640127b">Third-party</CmsText></h3>
        <p><CmsText id="cookies.d9796544327c">
        ...
        <h2><CmsText id="cookies.a1fe5433022c">3. Managing your preferences</CmsText></h2>
        <p><CmsText id="cookies.3360098d9326">
        ...
        <h2><CmsText id="cookies.4551a35576be">4. Children</CmsText></h2>
        <p><CmsText id="cookies.be6944417871">
          Our site is not directed at children under 13. We do not knowingly
          set cookies for tracking purposes on minors.
        </CmsText></p>

        <h2><CmsText id="cookies.74e470214dff">5. Updates</CmsText></h2>
        <p><CmsText id="cookies.ab9b133e5e4e">
          When we add or remove cookies we update this notice. The "last
          updated" date at the top reflects the most recent change.
        </CmsText></p>

        <h2><CmsText id="cookies.a65495406f80">6. Contact</CmsText></h2>
        <p><CmsText id="cookies.8ffcb9af27d1">
          Questions? Email </CmsText><a href={`mailto:${EMAIL}`}>{EMAIL}</a><CmsText id="cookies.cdb4ee2aea69">.
        </CmsText></p>
      </LegalPage>
      <Footer />
    </div>
