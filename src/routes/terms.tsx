  ...
  head: () => ({
    meta: [
      { title: "Terms of Service - Scholars Cafe" },
      {
        name: "description",
        content:
          "The terms that govern your use of Scholars Cafe's admissions consultancy and related services.",
      },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LegalPage
        ...
        updated="May 2026"
        intro={cmsLabel("terms.label.5d678bb779f1","By engaging Scholars Cafe, for a consultation or any of our admissions programs, you agree to the following terms. They are written in plain language so you know exactly what to expect from us, and what we expect from you.")}
      >
        <h2><CmsText id="terms.dec38f4494e4">1. The services we provide</CmsText></h2>
        <p><CmsText id="terms.b4f921fcf884">
        ...
        <h2><CmsText id="terms.fab830d24d95">2. No guarantee of admission</CmsText></h2>
        <p><CmsText id="terms.db553aa231fc">
        ...
        <h2><CmsText id="terms.359bb0cab9ff">3. Your responsibilities</CmsText></h2>
        <ul>
          <li><CmsText id="terms.d12b00548596">Provide accurate and truthful information at every stage.</CmsText></li>
          <li><CmsText id="terms.c813c13cb5ee">Submit drafts, documents, and decisions by the agreed deadlines.</CmsText></li>
          <li><CmsText id="terms.5790424f852b">
            Communicate honestly with universities, test agencies, and
            consulates. We will not assist with any form of fraud or
            misrepresentation.
          </CmsText></li>
          <li><CmsText id="terms.d03a3137f31d">Pay invoices according to your service agreement.</CmsText></li>
        </ul>

        <h2><CmsText id="terms.e18f4ec3780d">4. Fees and refunds</CmsText></h2>
        <p><CmsText id="terms.811b80eade69">
        ...
        <h2><CmsText id="terms.d209739ac7ad">5. Confidentiality</CmsText></h2>
        <p><CmsText id="terms.be6784e3c0a5">
          We treat everything you share, including academic records, family finances,
          and personal essays, as confidential. We will never use your story or
          documents publicly without explicit written permission. (See our
          Privacy Policy for full details.)
        </CmsText></p>

        <h2><CmsText id="terms.6b64ac8feb92">6. Intellectual property</CmsText></h2>
        <p><CmsText id="terms.5f8d045a217b">
        ...
        <h2><CmsText id="terms.f145229f542d">7. Limitation of liability</CmsText></h2>
        <p><CmsText id="terms.ac0b0aa89956">
        ...
        <h2><CmsText id="terms.a1f79986f68c">8. Governing law</CmsText></h2>
        <p><CmsText id="terms.eb762c233d2f">
        ...
        <h2><CmsText id="terms.e369ec3c2986">9. Changes</CmsText></h2>
        <p><CmsText id="terms.68fb6c863ba2">
        ...
        <h2><CmsText id="terms.2f41786a75a2">10. Contact</CmsText></h2>
        <p><CmsText id="terms.848f6cc06630">
          Questions about these terms? Email</CmsText>{" "}
          <a href={`mailto:${EMAIL}`}>{EMAIL}</a><CmsText id="terms.d081278dd35e"> and we'll get back to you
