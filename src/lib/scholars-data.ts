...
=======
  { value: 12, suffix: "+", label: "Countries We Support" },
  { value: 100, suffix: "%", label: "Dedicated Support" },
  { value: 3, suffix: "+", label: "Scholarship Tracks" },
...
=======
  { initials: "NN", name: "Nishat Niha", role: "CFO and Co-founder", bio: "Currently studying at Cudwell University in the US." },
  { initials: "MS", name: "Mridul Sheikh", role: "CEO and Co-founder", bio: "Got accepted into more than 50 universities and secured a huge amount of scholarships." },
  { initials: "HS", name: "Hasan Nawaz Shahzer", role: "US Admissions Trainer", bio: "Got accepted into top US liberal arts colleges and received a generous amount of scholarship support; he also trains students for US admissions." },
>>>>>>> eba62a0 (Update stats and team bios)
];
